...
* `save_bandwidth=0` - player will retrieve video from http source (default).
* `save_bandwidth=1` - player will attempt to retrieve video from Hola P2P CDN, resulting in bandiwdth savings and no buffering.
