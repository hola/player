...
* `bandwidth_savings=0` - player will retrieve video from source (default)
* `bandwidth_savings=1` - player will attempt to retrieve video from Hola CDN, resulting in bandiwdth savings 
